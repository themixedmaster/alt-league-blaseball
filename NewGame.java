...
public class NewGame //name will be changed to Game when finished and replace current Game class
{
    ...
    public NewGame(Team teamA, Team teamB, int dayNum, long startTime){
        this.teamA = teamA;
        this.teamB = teamB;
        this.dayNum = dayNum;
    ...
    public void simulateGame(){
        ...
        while(!endOfGame()){
            ...
            while(!endOfInning()){
                ...
                outs++;
                //everything after here is not written yet
            }
        }
    }
